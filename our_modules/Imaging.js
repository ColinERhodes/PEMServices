var ImagingMock = [
    {
         ...
         iPADURL : 'URLToLaunch = "eunity://?host=iwerp-demo.ehgt.com&port=443&protocol=https&studyUID=1.2.250.1.59.453.859.2960729188.3728.1274191976.2.1.1&user=DemoUser&password=demo";'
        }
    ];
